...
<p>
    ...
    Time-Stempeluhr, Unit-Messungen sowie optionale ESG-/Compliance-Erfassung und IoT Connect (Sensor-Events in den Workflow).
</p>
...
<ul>
    ...
    <li>Time (Stempeluhr) nutzen: Ein-/Ausstempeln über Clock-Point-QR, Stundenliste, optionaler Dienstplan (einschließlich Abwesenheiten), optionale Mindestpause pro Team auf der Stundenliste (kein extra RSZ-Ereignis), mit Kopplung eines Geräts pro Ausführendem.</li>
