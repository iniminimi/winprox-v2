...
<table>
    ...
    <tbody>
        <tr>
            <td>Cloud86</td>
            <td>Hosting della piattaforma (incl. backup giornalieri)</td>
            <td>UE</td>
        </tr>
        <tr>
            <td>SMTP Cloud86</td>
            <td>E-mail transazionali dell’applicazione</td>
            <td>UE</td>
        </tr>
        <tr>
            <td>Amazon SES</td>
            <td>Invio delle campagne promozionali</td>
            <td>UE</td>
        </tr>
        <tr>
            <td>Ollama (locale)</td>
...
<h2>Modifiche</h2>
<p>
    L'elenco può essere aggiornato quando vengono aggiunti nuovi sub-responsabili.
</p>
