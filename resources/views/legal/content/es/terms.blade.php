...
<ul>
    ...
    <li>usar Time (reloj de fichaje): fichar entrada/salida mediante el QR Clock Point, parte de horas, cuadrante opcional (incluidas ausencias), pausa mínima opcional por equipo en el parte (sin evento RSZ extra), con un dispositivo vinculado por trabajador.</li>
