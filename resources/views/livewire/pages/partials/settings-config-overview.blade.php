...
<div class="wp-config-overview-kpis">
    <div class="wp-config-overview-kpi">
        ...
        <p class="wp-config-overview-kpi__value wp-tabular">{{ $configSummary->inactiveLocationCount }}</p>
    </div>
    <div class="wp-config-overview-kpi">
        <p class="wp-config-overview-kpi__label">{{ __('settings.config_overview.kpi.inactive_units') }}</p>
        <p class="wp-config-overview-kpi__value wp-tabular">{{ $configSummary->inactiveUnitCount }}</p>
    </div>
    <div class="wp-config-overview-kpi">
        <p class="wp-config-overview-kpi__label">{{ __('settings.config_overview.kpi.inactive_teams') }}</p>
        <p class="wp-config-overview-kpi__value wp-tabular">{{ $configSummary->inactiveTeamCount }}</p>
    </div>
    <div class="wp-config-overview-kpi">
        <p class="wp-config-overview-kpi__label">{{ __('settings.config_overview.kpi.inactive_workers') }}</p>
        <p class="wp-config-overview-kpi__value wp-tabular">{{ $configSummary->inactiveWorkerCount }}</p>
    </div>
    <div class="wp-config-overview-kpi">
        <p class="wp-config-overview-kpi__label">{{ __('settings.config_overview.kpi.category_gps_on') }}</p>
        <p class="wp-config-overview-kpi__value wp-tabular">{{ $configSummary->categoryGpsEnabledCount }}</p>
    </div>
    <div class="wp-config-overview-kpi">
        <p class="wp-config-overview-kpi__label">{{ __('settings.config_overview.kpi.category_gps_off') }}</p>
        <p class="wp-config-overview-kpi__value wp-tabular">{{ $configSummary->categoryGpsDisabledCount }}</p>
    </div>
    <div class="wp-config-overview-kpi">
        <p class="wp-config-overview-kpi__label">{{ __('settings.config_overview.kpi.documents_active') }}</p>
        <p class="wp-config-overview-kpi__value wp-tabular">{{ $configSummary->activeDocumentCount }}</p>
    </div>
    <div class="wp-config-overview-kpi">
        <p class="wp-config-overview-kpi__label">{{ __('settings.config_overview.kpi.documents_inactive') }}</p>
        <p class="wp-config-overview-kpi__value wp-tabular">{{ $configSummary->inactiveDocumentCount }}</p>
    </div>
</div>
