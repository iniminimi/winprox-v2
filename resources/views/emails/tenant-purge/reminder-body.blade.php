<p>{{ __('mail.tenant_purge.reminder.body', [
    'tenant' => $tenantName,
    'date' => $scheduledAt,
    'timezone' => $timezone,
]) }}</p>
...
<p>{{ __('mail.tenant_purge.reminder.cancel') }}</p>
<p style="font-size: 13px; color: #64748b;">{{ __('mail.tenant_purge.reminder.footer') }}</p>
