...
class TranslationBackfillSlotsCommand extends Command
{
    ...
    protected $description = 'Maak ontbrekende vertaal-slots voor goedgekeurde meldingen, actieve mededelingen, actieve units, taken met omschrijving en actieve documenten';
