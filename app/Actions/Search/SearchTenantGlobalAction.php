...
final class SearchTenantGlobalAction
{
    ...
    private function searchPages(array $terms): Collection
    {
        $pages = [
            ...
            ['id' => 'checklists', 'route' => 'checklists.index', 'label' => 'common.nav.checklists'],
            ['id' => 'unit_checks', 'route' => 'unit-checks.index', 'label' => 'common.nav.unit_checks'],
            ['id' => 'work_visits', 'route' => 'work-visits.index', 'label' => 'common.nav.work_visits'],
