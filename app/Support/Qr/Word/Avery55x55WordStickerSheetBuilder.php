...
{
    private const QR_IMAGE_MM = 42.0;
    ...
    private function addStickerTable(
        ...
        $table = $section->addTable([
            ...
            'width' => Avery55x55StickerTableLayout::tableWidthTwip(),
            'unit' => 'dxa',
        ...
        for ($rowIndex = 0; $rowIndex < Avery55x55StickerTableLayout::ROW_COUNT; $rowIndex++) {
            $table->addRow(Avery55x55StickerTableLayout::ROW_TWIP, [
                'exactHeight' => true,
                'cantSplit' => true,
            ]);

            for ($columnIndex = 0; $columnIndex < count(Avery55x55StickerTableLayout::GRID_COLUMN_TWIPS); $columnIndex++) {
                $isLabelColumn = in_array($columnIndex, Avery55x55StickerTableLayout::LABEL_COLUMN_INDEXES, true);
                $widthTwip = Avery55x55StickerTableLayout::GRID_COLUMN_TWIPS[$columnIndex];
    ...
    private static function sectionStyle(bool $startsOnNewPage): array
    {
        $style = [
            ...
            'marginTop' => Avery55x55StickerTableLayout::PAGE_MARGIN_TOP_TWIP,
            'marginBottom' => Avery55x55StickerTableLayout::PAGE_MARGIN_BOTTOM_TWIP,
            'marginLeft' => Avery55x55StickerTableLayout::PAGE_MARGIN_LEFT_TWIP,
            'marginRight' => Avery55x55StickerTableLayout::PAGE_MARGIN_RIGHT_TWIP,
        ];
    ...
    private function saveToString(PhpWord $phpWord): string
    {
        ...
        try {
            ...
            WordDocxStickerExportSanitizer::apply($docxPath, QrStickerSheetTemplate::Avery55x55S);
