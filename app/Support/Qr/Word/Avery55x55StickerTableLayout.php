...
/**
 * Avery 55×55-S Word table grid (from tests/Avery_55x55-S.docx).
 */
final class Avery55x55StickerTableLayout
{
    /** @var list<int> */
    public const GRID_COLUMN_TWIPS = [3118, 283, 3118, 283, 3118];

    public const ROW_TWIP = 3118;
    ...
    public const PAGE_MARGIN_TOP_TWIP = 623;

    public const PAGE_MARGIN_RIGHT_TWIP = 446;

    public const PAGE_MARGIN_BOTTOM_TWIP = 503;

    /** Avery label guides sit at 49.6 pt (992 twips), not the template pgMar 1117. */
    public const PAGE_MARGIN_LEFT_TWIP = 992;
