...
it('toont de uitgebreide realestate-landing', function () {
    $this->get(route('realestate', ['locale' => 'nl']))
        ...
        ->assertSee('id="landing-video"', false)
        ->assertSee('hospitality_long_NL.mp4', false)
        ->assertSee('wp-video--sm', false)
...
it('toont de schoonmaak- en bouwlanding', function () {
    ...
    $this->get(route('work-on-location', ['locale' => 'nl']))
        ...
        ->assertSee(__('landings.work-on-location.schedule.title', [], 'nl'))
        ->assertSee('images/landing/work_on_location/image01.jpg', false)
        ->assertSee('images/landing/work_on_location/screenshot_cleaning.jpg', false)
