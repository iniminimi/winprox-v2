...
it('filtert platform-uitschrijvingen op onbezorgbaar', function () {
    ...
    Livewire::actingAs($superuser)
        ...
        ->assertSee(__('platform.email_unsubscribe.source_voluntary').' (1)')
        ->assertSee(__('platform.email_unsubscribe.source_undeliverable').' (1)')
        ->assertSee(__('platform.email_unsubscribe.source_manual').' (1)')
