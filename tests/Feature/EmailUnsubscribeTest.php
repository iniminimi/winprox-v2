...
it('filtert platform-uitschrijvingen op onbezorgbaar', function () {
    ...
    Livewire::actingAs($superuser)
        ...
        ->assertSee(__('platform.email_unsubscribe.filter_source'))
        ->assertSee(__('platform.email_unsubscribe.filter_voluntary', ['count' => 1]))
        ->assertSee(__('platform.email_unsubscribe.filter_voluntary_hint'))
        ->assertSee(__('platform.email_unsubscribe.filter_undeliverable', ['count' => 1]))
        ->assertSee(__('platform.email_unsubscribe.filter_undeliverable_hint'))
        ->assertSee(__('platform.email_unsubscribe.filter_manual', ['count' => 1]))
        ->assertSee(__('platform.email_unsubscribe.filter_manual_hint'))
        ->assertSee(__('platform.email_unsubscribe.filter_empty_means_all'))
