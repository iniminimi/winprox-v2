...
| Time / Clock Point | Shifts, bound device, hashed PIN, optional GPS, own-hours view, team-applied timesheet break (not RSZ), evacuation-list views | Controller | Processor | Optional punch clock; one phone per worker |
