...
- [x] `DONE` Time/Clock Point: one device per worker, hashed PIN, optional GPS (fail-open), evacuation-list audit; cookies policy names the essential device cookie (2026-09-06).
