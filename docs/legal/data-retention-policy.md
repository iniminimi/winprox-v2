...
| Time / Clock Point | Shifts, breaks (including team-applied timesheet minimum; not an RSZ event), bound device, hashed PIN, optional GPS at punch, own-hours view, planned roster, worker in-app roster notifications, evacuation-list views | Contract period + 36 months | Delete with tenant / related records |
