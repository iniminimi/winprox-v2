...
| Time / Clock Point (optionele module) | Uitvoering overeenkomst (aanwezigheid) | Uitvoerders (zonder login) | Zie retentiebeleid | Toestelcookie, gehashte PIN, optionele GPS bij de prik, audit evacuatielijst; geen extra subverwerker |
