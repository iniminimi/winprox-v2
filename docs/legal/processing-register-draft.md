...
| Time / Clock Point (optionele module) | Uitvoering overeenkomst (aanwezigheid) | Uitvoerders (zonder login) | Zie retentiebeleid | Toestelcookie, gehashte PIN, optionele GPS bij de prik, eigen uren op Clock Point, teampauze-minuten op de urenstaat (geen extra RSZ-event), gepland uurrooster en afwezigheden (verlof/recup/ziek) die de klant invoert, audit evacuatielijst; geen extra subverwerker |
