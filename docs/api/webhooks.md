...
| `document.translation_imported` | A completed document translation was imported | Translation metadata |
...
`issue.translation_imported`, `announcement.translation_imported`, `unit.translation_imported`, `task.translation_imported`, and `document.translation_imported` fire when a translation is stored via the translation import API or sync pipeline (not when Ollama translates in-app).
